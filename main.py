...
st.markdown("Análise geral dos estudos clínicos | Atualizado em 2025-07-07")
st.markdown("---")
...
dados = {
    ...
    "Inaptos_Homens":       [1, 0, 1, 1, 0, 1, 0, 1],
    "Inaptos_Mulheres":     [0, 1, 1, 0, 0, 2, 0, 0],
    "Aptos_Homens":         [3, 0, 0, 3, 0, 3, 3, 0],
    "Aptos_Mulheres":       [2, 3, 0, 0, 1, 3, 2, 1],
